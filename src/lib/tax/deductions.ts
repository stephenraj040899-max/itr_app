...
export function oldRegimeDeductions(input:TaxInput):{total:bigint;trace:TaxTrace[]}{
 ...
 const education=input.deductions.section80E??0n; add("80E",education,education,"Education-loan interest requires borrower, purpose and payment evidence");
 ...
 return {total:s80c+nps+d+education+interest+salaryStandard+donation,trace};
}
