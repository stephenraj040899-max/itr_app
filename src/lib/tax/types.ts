...
export interface TaxInput { grossIncomeRupees:bigint; salaryIncomeRupees:bigint; tdsRupees:bigint; ageBand:TaxpayerAgeBand; deductions:{ section80CGroup:bigint; section80CCD1B:bigint; section80D:bigint; section80E?:bigint; section80TTA:bigint; section80TTB:bigint; section80G:bigint } }
